...
The package only depends on [`httpx`](https://www.python-httpx.org/), nothing else. Tested on CPython 3.9 – 3.12.
...
Mirrors the five canonical CLI verbs documented in the [SKILL.md](https://agentnetwork.org.cn/SKILL.md) and CLI-STABLE-v1 contracts.
...
The package ships with three small executable demos under [`anet/examples/`](anet/examples/):
